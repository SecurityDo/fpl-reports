...
** for username "foo@gmail.com", two new columns "Name" and "Domain" will be added with value "foo" and "gmail.com" respectively
```
let Email = f("Email")
...
** if variable is Metric, returns the number of data series in the metric
...
**       "Tuple", "Map", "Lambda", "Table", "Metric", "Alert"
