...
* Fluency_Tenant_Device_Lookup(tenant, ipAddress)
** Lookup Tenant device information from Fluency Device database
* Fluency_Tenant_Device_LookupName(tenant, deviceName)
** Lookup tenant device information by name from Fluency Device database
* Fluency_Tenant_Device_Add(tenant, device)
** Add device information to Fluency Tenant Device database
* Fluency_Tenant_Device_Update(tenant, ipAddress, newName)
** assign ipAddress to a new name
* Fluency_Tenant_Device_Delete(tenant, deviceName)
** delete device by name
----
function main({obj, size}) {
